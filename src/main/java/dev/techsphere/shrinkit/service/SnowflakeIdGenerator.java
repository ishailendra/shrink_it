...
// Reference - https://github.com/malickatique/spring-boot-twitter-snowflake-id/tree/main
@Component
public class SnowflakeIdGenerator {
    ...
    public SnowflakeIdGenerator(ConsulMachineIdAssigner consulAssigner) {
        this.datacenterId = consulAssigner.getDatacenterId();
        this.machineId = consulAssigner.getMachineId();
